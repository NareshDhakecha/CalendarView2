...
import com.ndsoftwares.calendarviewexample.databinding.Example3CalendarDayBinding
import com.ndsoftwares.calendarviewexample.databinding.Example3CalendarHeaderBinding
import com.ndsoftwares.calendarviewexample.databinding.Example3EventItemViewBinding
import com.ndsoftwares.calendarviewexample.databinding.Example3FragmentBinding
...
class Example3Fragment : BaseFragment(R.layout.example_3_fragment), HasBackButton {
    ...
    private lateinit var bv: Example3FragmentBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bv = Example3FragmentBinding.bind(view)
        ...
        bv.exThreeCalendar.apply {
            setup(currentMonth.minusMonths(10), currentMonth.plusMonths(10), daysOfWeek.first())
            scrollToMonth(currentMonth)
        }

        if (savedInstanceState == null) {
            bv.exThreeCalendar.post {
        ...
        bv.exThreeCalendar.dayBinder = object : DayBinder<DayViewContainer> {
        ...
        bv.exThreeCalendar.monthScrollListener = {
        ...
        bv.exThreeCalendar.monthHeaderBinder = object :
        ...
        bv.exThreeAddButton.setOnClickListener {
            inputDialog.show()
        }
    }
    ...
    private fun selectDate(date: LocalDate) {
        if (selectedDate != date) {
            ...
            selectedDate = date
            oldDate?.let { bv.exThreeCalendar.notifyDateChanged(it) }
            bv.exThreeCalendar.notifyDateChanged(date)
    ...
    private fun updateAdapterForDate(date: LocalDate) {
        ...
        bv.exThreeSelectedDateText.text = selectionFormatter.format(date)
    }
