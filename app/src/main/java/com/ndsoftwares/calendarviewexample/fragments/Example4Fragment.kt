...
import com.ndsoftwares.calendarviewexample.databinding.Example4CalendarDayBinding
import com.ndsoftwares.calendarviewexample.databinding.Example4CalendarHeaderBinding
import com.ndsoftwares.calendarviewexample.databinding.Example4FragmentBinding
...
class Example4Fragment  : BaseFragment(R.layout.example_4_fragment), HasToolbar, HasBackButton {
    ...
    private lateinit var bv: Example4FragmentBinding

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        setHasOptionsMenu(true)
        bv = Example4FragmentBinding.bind(view)
        ...
        bv.exFourCalendar.post {
            val radius = ((bv.exFourCalendar.width / 7) / 2).toFloat()
        ...
        bv.exFourCalendar.setup(currentMonth, currentMonth.plusMonths(12), daysOfWeek.first())
        bv.exFourCalendar.scrollToMonth(currentMonth)
            ...
            init {
                view.setOnClickListener {
                    if (day.owner == DayOwner.THIS_MONTH && (day.date == today || day.date.isAfter(today))) {
                        ...
                        this@Example4Fragment.bv.exFourCalendar.notifyCalendarChanged()
                        bindSummaryViews()
                    }
                }
            }
        ...
        bv.exFourCalendar.dayBinder = object : DayBinder<DayViewContainer> {
        ...
        bv.exFourCalendar.monthHeaderBinder = object :
        ...
        bv.exFourSaveButton.setOnClickListener click@{
            val startDate = startDate
            val endDate = endDate
    ...
    private fun bindSummaryViews() {
        ...
        bv.exFourSaveButton.isEnabled = endDate != null || (startDate == null && endDate == null)
    }

    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.example_4_menu, menu)
        bv.exFourToolbar.post {
            // Configure menu text to match what is in the Airbnb app.
            bv.exFourToolbar.findViewById<TextView>(R.id.menuItemClear).apply {
        ...
        menu.findItem(R.id.menuItemClear).setOnMenuItemClickListener {
            startDate = null
            endDate = null
            bv.exFourCalendar.notifyCalendarChanged()
            bindSummaryViews()
            true
        }
    }
