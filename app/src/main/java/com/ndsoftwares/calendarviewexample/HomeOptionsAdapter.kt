...
import com.ndsoftwares.calendarviewexample.databinding.HomeOptionsItemViewBinding
import com.ndsoftwares.calendarviewexample.fragments.*
...
class HomeOptionsAdapter(val onClick: (ExampleItem) -> Unit) :
    ...
    inner class HomeOptionsViewHolder (
            private val binding: HomeOptionsItemViewBinding
